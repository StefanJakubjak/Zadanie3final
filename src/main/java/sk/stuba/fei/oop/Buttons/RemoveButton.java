...
import sk.stuba.fei.oop.Listeners.DeleteListener;
...
public class RemoveButton extends Button implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        DeleteListener deleteListenner = new DeleteListener(netFrame.getNet(),netCanvas);
        for (MouseListener mouseListener:netCanvas.getMouseListeners())
        {netCanvas.removeMouseListener(mouseListener);}
        netCanvas.addMouseListener(deleteListenner);
    }
