...
public class AddPlaceButton extends Button implements MouseListener{
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        netFrame.setTitle(" ");
        AddPlaceListener placeListenner = new AddPlaceListener(netFrame.getNet(),netCanvas);

        for (MouseListener mouseListener:netCanvas.getMouseListeners())
        {netCanvas.removeMouseListener(mouseListener);}
        netCanvas.addMouseListener(placeListenner);
